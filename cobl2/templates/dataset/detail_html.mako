...
<p>&#8230; a new breed of language databases on <strong>Co</strong>gnate <strong>R</strong>elationships across language families, implemented here in the first instance to the <strong>I</strong>ndo-<strong>E</strong>uropean language family.</p>

<p>IE-CoR is the database used in the phylogenetic analyses of the Indo-European family in <em>Language trees with sampled ancestors support a hybrid model for the origin of Indo-European languages</em> ${h.external_link('https://doi.org/10.1126/science.abg0818', label='Heggarty et al. 2023')} in <em>Science</em>.</p>
...
<p>For full details on the IE-CoR protocols for lexeme and cognate determination, see respectively sections 3.5 and 3.6 of the ${h.external_link('https://www.science.org/action/downloadSupplement?doi=10.1126%2Fscience.abg0818&file=science.abg0818_sm.pdf', label='supplementary information')} to the article ${h.external_link('https://doi.org/10.1126/science.abg0818', label='Heggarty et al. 2023')} in <em>Science</em>.</p>
