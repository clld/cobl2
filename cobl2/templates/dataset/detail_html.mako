...
<p>Data are compiled through the ${h.external_link('https://iecor.info', label='CoR online database creation system')}, by a consortium of language and branch experts across the Indo-European family, working together with cross-family cognacy specialists to determine cognate status.  </p>
